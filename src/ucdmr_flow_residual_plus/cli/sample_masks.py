...
def build_parser() -> ArgumentParser:
    ...
    parser.add_argument("--inpaint-radius", type=int, default=9)
    parser.add_argument("--band-radius", type=int, default=5)
    parser.add_argument("--gate-radius", type=int, default=7)
    parser.add_argument("--gate-blur", type=float, default=3.0)
    return parser
