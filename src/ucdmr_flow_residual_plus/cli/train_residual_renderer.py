...
from ucdmr_flow_residual_plus.training.train_residual_renderer import dry_run_summary, train


def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Train U-CDMR-Flow-Residual+ pretrained-encoder residual renderer.")
    ...
    parser.add_argument("--lambda-inside", type=float, default=1.0)
    parser.add_argument("--lambda-outside", type=float, default=2.0)
    parser.add_argument("--lambda-leak", type=float, default=2.0)
